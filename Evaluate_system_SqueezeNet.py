...
''' For SqueezeNet_model'''
'''------------------------------------------------------------'''
print('Loading SqueezeNet model')
Classifier = SqueezeNet_model()
print('Loaded SqueezeNet model successfully')
'''------------------------------------------------------------'''


'''load weights'''
print('Loading SqueezeNet weights')
model_path_RMSprop= "./model_files/SquuezeNet_optimizer_RMSprop.h5"
Classifier.load_weights(model_path_RMSprop)
print('Loaded SqueezeNet weights successfully')
...
======================================================
"""
analysedpath = './analysed_images/SqueezeNet_RMSprop/'
